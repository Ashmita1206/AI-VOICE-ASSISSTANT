...
from agentic.file_context_search.scanner import scan_drives
...
from agentic.file_context_search.extractor import extract_entities
...
class DocumentIndexer:
    ...
    :mod:`agentic.file_context_search.manager`.
    """
    ...
    def _index_single_file(self, file_path: str, stat: os.stat_result) -> None:
        ...
        entities_json = extract_entities(text) if text else "{}"
